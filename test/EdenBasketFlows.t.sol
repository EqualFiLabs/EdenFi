...
contract EdenBasketFlowsTest is EdenLaunchFixture {
    ...
    function test_CreateBasket_WalletMintBurnAndMetadata() public {
        ...
        maxInputs[0] = 11e18;
        EdenBasketWalletFacet(diamond).mintBasket(basketId, 10e18, bob, maxInputs);
        vm.stopPrank();
        ...
        vm.prank(bob);
        EdenBasketWalletFacet(diamond).burnBasket(basketId, 10e18, bob);
    ...
    function test_CreateBasket_RevertsForMissingCanonicalPool() public {
        ...
        bytes memory data = abi.encodeWithSelector(EdenBasketWalletFacet.createBasket.selector, params);
    ...
    function test_MintBasket_RevertsForInvalidUnitsPausedBasketAndInputShape() public {
        ...
        EdenBasketWalletFacet(diamond).mintBasket(basketId, 10e18, bob, wrongLen);

        uint256[] memory maxInputs = new uint256[](1);
        maxInputs[0] = 11e18;
        vm.expectRevert(InvalidUnits.selector);
        EdenBasketWalletFacet(diamond).mintBasket(basketId, 0, bob, maxInputs);
