...
// Smoke coverage only: this suite intentionally seeds library/accounting state directly.
// It is a synthetic substrate/library check, not an end-to-end EqualFi protocol proof.
...
contract SubstratePortSmokeTest {
